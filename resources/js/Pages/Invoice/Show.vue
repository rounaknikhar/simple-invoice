        ...
        <div class="pb-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-0">
                <div class="flex flex-1 justify-between py-4 px-4 md:px-0">
                    ...
                    <div>
                        <button class="btn btn-sm btn-accent rounded shadow-xl text-white">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th class="font-semibold text-black">{{ invoice.sub_total }}</th>
                                        </tr>
                                        <tr>
                                            <td class="font-semibold text-black">VAT %</td>
                                            <th></th>
                                            <th></th>
                                            <th class="font-semibold text-black">{{ invoice.vat_percentage }}%
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th class="font-semibold text-black">{{ invoice.total }}</th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
