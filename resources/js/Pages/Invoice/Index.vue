        ...
        <div class="py-12" v-auto-animate>
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex justify-between w-full p-4">
                        <form @submit.prevent="search">
                            <div class="w-full md:w-auto mr-2">
                                <label
                                    class="input input-bordered flex items-center px-0 pl-1"
                                >
                                    <input
                                        type="text"
                                        v-model="form.search"
                    ...
                    <div
                        v-if="page.props.query.search"
                        class="px-4 py-2 shadow w-full inline-block"
                    >
                        Showing results for
                        <span class="underline"
                            ><b>{{ page.props.query.search }}</b></span
                        >
                        <Link
