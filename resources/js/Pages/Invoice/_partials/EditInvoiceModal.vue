                ...
                <div class="py-4">
                    <div class="grid grid-cols-1">
                        ...
                        <label class="py-2 form-control w-full">
                            ...
                            <!-- Error message -->
                            <span
                                v-if="form.errors?.company_vat_number"
                                class="label-text-alt text-red-600 my-2"
                            >
                                {{ form.errors?.company_vat_number }}
                            </span>
                        ...
                        <label class="py-2 form-control w-full">
                            ...
                            <!-- Error message -->
                            <span
                                v-if="form.errors?.company_address_line_1"
                                class="label-text-alt text-red-600 my-2"
                            >
                                {{ form.errors?.company_address_line_1 }}
                            </span>
                        ...
                        <label class="py-2 form-control w-full">
                            ...
                            <!-- Error message -->
                            <span
                                v-if="form.errors?.company_address_line_2"
                                class="label-text-alt text-red-600 my-2"
                            >
                                {{ form.errors?.company_address_line_2 }}
                            </span>
                        ...
                        <label class="py-2 form-control w-full">
                            ...
                            <input
                                type="text"
                                v-model="form.client_address_line_1"
                                class="input input-bordered w-full"
                                :class="
                            ...
                            <!-- Error message -->
                            <span
                                v-if="form.errors?.client_address_line_1"
                                class="label-text-alt text-red-600 my-2"
                            >
                                {{ form.errors?.client_address_line_1 }}
                            </span>
                        ...
                        <label class="py-2 form-control w-full">
                            ...
                            <!-- Error message -->
                            <span
                                v-if="form.errors?.client_address_line_2"
                                class="label-text-alt text-red-600 my-2"
                            >
                                {{ form.errors?.client_address_line_2 }}
                            </span>
                        ...
                        <label class="py-2 form-control w-full">
                            ...
                            <!-- Error message -->
                            <span
                                v-if="form.errors?.client_county"
                                class="label-text-alt text-red-600 my-2"
                            >
                                {{ form.errors?.client_county }}
                            </span>
                        ...
                        <label class="py-2 form-control w-full">
                            ...
                            <!-- Error message -->
                            <span
                                v-if="form.errors?.client_postcode"
                                class="label-text-alt text-red-600 my-2"
                            >
                                {{ form.errors?.client_postcode }}
                            </span>
                        ...
                        <label class="py-2 form-control w-full hidden">
                            ...
                            <input
                                ...
                                placeholder="Total"
                                :class="
                                    form.errors?.total ? 'border-red-600' : ''
                                "
                            />
                            <!-- Error message -->
                            <span
