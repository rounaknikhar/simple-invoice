    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="bg-base-100 overflow-hidden shadow-sm sm:rounded-lg"
                >
                    <form @submit.prevent="submit" class="px-6">
                        <div class="p-6">
                            ...
                            <div
                                class="grid grid-cols-1 md:grid-cols-2 my-6 mx-3"
                            >
                                <div
                                ...
                                <div
                                    class="md:flex md:justify-end md:mt-0 mt-3"
                                >
                                    <div
                                        class="card bg-base-100 w-full md:w-[95%] shadow-xl"
                                    >
                                        <div class="card-body">
                                            ...
                                            <label
                                                class="py-2 form-control w-full"
                                            >
                                                <div class="label">
                                                    <span class="label-text">
                                                        Name
